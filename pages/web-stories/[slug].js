  ...
  return (
    ...
    <>
      ...
      <amp-story standalone="" title={`${story.title}`} publisher={`${APP_NAME}`} publisher-logo-src="http://www.naukarisamachar.live/wp-content/uploads/2023/06/cropped-Logo-1.png" poster-portrait-src={`${story.coverphoto}`} >
        ...
        <amp-story-page id="000" distance="0" aria-hidden="false" auto-advance-after="4s" className="i-amphtml-layout-container i-amphtml-element i-amphtml-built i-amphtml-layout i-amphtml-story-page-loaded" role="region" i-amphtml-layout="container" >
